package com.mn.insta.page.functions.settings;
...
import com.mn.insta.page.utility.CustomExcelPageDataProvider;
import com.mn.insta.page.utility.CustomSQLElementProvider;
import com.mn.insta.page.utility.CustomSQLPageDataProvider;
import com.mn.insta.page.utility.QTestIntegration;
import com.mn.insta.page.utility.TestMatrixGenarator;
...
public class Setup  extends AbstractSeleniumTest{
	...
	public Setup()   {
		...
		File configFile = new File("resources//driverConfig.txt");
